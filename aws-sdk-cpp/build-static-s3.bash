...
docker build \
	...
	--tag aws-sdk-cpp-static-s3:${AWS_SDK_CPP_VERSION} \
	.

echo "Use the following to update the Docker Hub repository"
echo "  docker login"
echo "  docker tag aws-sdk-cpp-static-s3:${AWS_SDK_CPP_VERSION} andykirkham/aws-sdk-cpp:static-s3-${AWS_SDK_CPP_VERSION}"
echo "  docker push andykirkham/aws-sdk-cpp:static-s3-${AWS_SDK_CPP_VERSION}"
