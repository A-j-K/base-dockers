...
docker build \
	...
	-f Dockerfile.core \
	--tag aws-sdk-cpp-core:${AWS_SDK_CPP_VERSION} \
	.

echo "Use the following to update the Docker Hub repository"
echo "  docker login"
echo "  docker tag aws-sdk-cpp-core:${AWS_SDK_CPP_VERSION} andykirkham/aws-sdk-cpp:core-${AWS_SDK_CPP_VERSION}"
echo "  docker push andykirkham/aws-sdk-cpp:core-${AWS_SDK_CPP_VERSION}"
